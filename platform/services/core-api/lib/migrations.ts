...
const migrations = [
  ...
  { id: "005_lms", url: new URL("../migrations/005_lms.sql", import.meta.url) },
  { id: "006_portal_experience", url: new URL("../migrations/006_portal_experience.sql", import.meta.url) },
];
