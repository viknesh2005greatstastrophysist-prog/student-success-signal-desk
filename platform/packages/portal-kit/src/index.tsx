...
import { Chapter11Workbench } from "./chapter11";
      ...
      {status === "ready" && snapshot ? (
        <>
          ...
          <div className="portal-workspace">
            ...
            {((portal.id === "faculty" && activeView === "Cases") || (portal.id === "governance" && activeView === "Operations") || (portal.id === "hod" && activeView === "Cases")) ? <Chapter11Workbench role={portal.id as "faculty" | "governance" | "hod"} csrfToken={csrfToken} refresh={load} /> : null}
